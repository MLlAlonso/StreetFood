...
<body style=" margin:0; padding:0; background:#F0F0F0; font-family:Arial, Helvetica, sans-serif">
    <table width="100%" cellpadding="0" cellspacing="0" style="padding:40px 20px;" >
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style=" background:#FFFFFF; border-radius:20px; border:2px solid #E0E0E0; overflow:hidden; " >
                    <!-- HEADER -->
                    <tr>
                        <td align="center" style=" background:#0A0F23; padding:20px; " >
                            <img
                                src="https://res.cloudinary.com/dhzmsgmq2/image/upload/v1780535699/logo_llqhcy.png"
                                alt="StreetEats"
                    ...
                    <tr>
                        <td style=" padding:40px; color:#262730; " >
                            ...
                            <div style=" background:#F7F7F7; border-radius:16px; padding:25px; text-align:center; margin-bottom:30px; " >
